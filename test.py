...
# 1. CONFIGURATION
# =========================
BATCH_SIZE = 64  # TPU يحب Batches كبيرة
EPOCHS = 40
LR = 1e-4
# تعريف الـ Device للـ TPU
...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img = img.convert("RGB") # سطر مهم جداً لتفادي أخطاء القنوات
...
for epoch in range(EPOCHS):
    ...
    for imgs, labels in loop:
        ...
        # تحسين خاص بالـ TPU: xm.optimizer_step
    ...
    if avg_val_acc > best_acc:
        ...
        # حفظ الموديل في TPU يحتاج xm.save بدل torch.save
